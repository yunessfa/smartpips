...
// `hideVolume` also removes the volume histogram, which TradingView draws on
// the price pane by default and is itself an indicator.
export function AdvancedChart({
  symbol, height = 500, interval = "240", studies = [], hideVolume = false,
}) {
  return (
    <TVEmbed
      height={height}
...
export function SignalChart({
  symbol, studies = [], height = 260, interval = "240", hideVolume = false,
}) {
  return (
    <TVEmbed
      height={height}
